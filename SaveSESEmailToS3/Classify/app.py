...
# Use environment variables to store sensitive details
bucket_name = os.getenv('BUCKET_NAME', 'your-bucket-name-placeholder')
openai.api_key = os.getenv('OPENAI_API_KEY', 'your-openai-api-key-placeholder')
